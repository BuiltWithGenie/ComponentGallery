...
StippleUI.layout(style="max-width:1500px;",
    [
        ...
        drawer(bordered="", fieldname="left_drawer_open", side="left", var":mini"="ministate", var"@mouseover"="ministate = false", var"@mouseout"="ministate = true", var"mini-to-overlay"=true, width="200",
        ...
        page_container(style="margin-left:30px",
            [
